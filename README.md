...
<head>
  ...
  <title>CUTZ FEAST | Graphic & Web Designer</title>
  ...
  <style>
    * {
    ...
    .fluid-bg::before {
      ...
      width: 200%;
      height: 200%;
      background: radial-gradient(circle at 10% 10%, #00ffff55, transparent 30%),
                  radial-gradient(circle at 90% 30%, #ff00ff33, transparent 30%),
                  radial-gradient(circle at 50% 90%, #00ffff44, transparent 40%);
      animation: animateFluid 20s linear infinite;
      opacity: 0.1;
    }
